...
@WebServlet(name = "DeletePendingAppointmentServlet", urlPatterns = {"/DeletePendingAppointmentServlet"})
public class DeletePendingAppointmentServlet extends HttpServlet {
